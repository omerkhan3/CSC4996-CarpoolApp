...
struct ScheduledRide: Decodable {
    ...
    init(json: [String: Any]) {
        ...
        riderPickupTime = json["riderPickupTime"] as? String ?? "<riderPickupTime>"
        riderDropOffTime = json["riderDropOffTime"] as? String ?? "<riderDropOffTime>"
        driverLeaveTime = json["driverLeaveTime"] as? String ?? "<driverLeaveTime>"
        riderPickupTime2 = json["riderPickupTime2"] as? String ?? "<riderPickupTime2>"
    ...
    init() {
        ...
        riderID = "<riderID>"
        driverID = "<driverID"
        riderPickupTime = "<riderPickupTime>"
        riderDropOffTime = "<riderDropOffTime>"
        driverLeaveTime = "<driverLeaveTime>"
        riderPickupTime2 = "<riderPickupTime2>"
