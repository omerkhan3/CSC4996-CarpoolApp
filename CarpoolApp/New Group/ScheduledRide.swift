...
struct ScheduledRide: Decodable {
    ...
    let driverDepartureTime1: String
    ...
    init(json: [String: Any]) {
        ...
        routeType = json["routeType"] as? String ?? "<route type>"
        driverDepartureTime1 = json["driverDepartureTime1"] as? String ?? ""
    }
