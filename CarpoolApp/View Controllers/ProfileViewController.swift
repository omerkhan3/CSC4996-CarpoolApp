...
class ProfileViewController: UIViewController, UITextFieldDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    {
        var viewProfileComponents = URLComponents(string: "http://141.217.48.208:3000/users/profile")!
    ...
    {
        let editProfileURL = URL(string: "http://141.217.48.208:3000/users/profile")!
