...
class FreqDestinations: UIViewController {
    ...
    @IBAction func saveButton(_ sender: Any) {
        ...
        let routeInfo = ["userID": userID, "Name": self.homeLabel.text! as Any, "Address": self.HomeSearchBar.text! as Any, "Name2": self.schoolLabel.text! as Any, "schoolAddress": self.SchoolSearchBar.text! as Any, "Name3": self.workLabel.text! as Any, "workAddress": self.WorkSearchBar.text! as Any, "Name4": self.otherInput.text! as Any, "otherAddress": self.otherSearchBar.text! as Any, "Name5": self.otherInput.text! as Any, "Longitudes": longitudeArray, "Latitudes": latitudeArray]
        //print(routeInfo)
